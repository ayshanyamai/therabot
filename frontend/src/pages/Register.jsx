...
function Register() {
  ...
  const strengthColor = ['bg-gray-200', 'bg-red-400', 'bg-orange-400', 'bg-yellow-400', 'bg-emerald-400', 'bg-emerald-500']
  ...
  return (
    <>
      <SEO
        ...
        description="Join TheraBot for free AI-powered mental health support. Create your account and start your wellness journey today."
        keywords="sign up, create account, register, mental health support, wellness app"
        canonical="/register"
      />
          ...
          <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
            <div className="mb-8">
              ...
              <h1 className="text-5xl xl:text-6xl font-bold text-white mb-6 leading-tight">
                Start Your
                <span className="block text-emerald-200">Wellness Journey</span>
              </h1>
              <p className="text-xl text-emerald-100 max-w-md leading-relaxed">
                Join thousands of people who trust Therabot for mental health support.
                  ...
                  <div className="mt-2">
                    <div className="flex gap-1 mb-1">
                      {[1, 2, 3, 4, 5].map((level) => (
                        <div
                          key={level}
                          className={`h-1.5 flex-1 rounded-full transition-colors ${passwordStrength() >= level ? strengthColor[passwordStrength()] : 'bg-gray-200'
                            }`}
                        />
                      ))}
                    </div>
                    <p className="text-xs text-gray-500">
                      {strengthText[passwordStrength()] || 'Start typing...'}
                    </p>
                  </div>
                )}
              </div>
